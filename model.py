...
class MobileNet:
    ...
    def __init_network(self):
        with tf.variable_scope('mobilenet_encoder'):
            ...
            # Model is here!
            # conv1_1 = conv2d('conv_1', ***, num_filters=int(round(32 * self.args.width_multiplier))
            conv1_1 = conv2d('conv_1', preprocessed_input, num_filters=int(np.round(32 * self.args.width_multiplier)),
                             kernel_size=(3, 3),
            ...
            ############################################################################################
            # conv2_1_dw, conv2_1_pw = depthwise_separable_conv2d('conv_ds_2', ***,
            #                                                     width_multiplier=self.args.width_multiplier,
            #                                                     num_filters=***, kernel_size=(3, 3), padding='SAME',
            #                                                     stride=(***, ***),
            #                                                     batchnorm_enabled=self.args.batchnorm_enabled,
